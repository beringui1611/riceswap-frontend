            ...
            <main className='bg-blue-950 flex justify-center items-top  max-w-full'>
                <section>
                    <div className="mx-5">
                        ...
                        <p className="text-gray-600  max-sm:p-3 mx-5 mb-20 md:text-3xl md:mt-20 sm:text-2xl sm:mt-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea incidunt odit cumque error illo dignissimos tenetur beatae nobis quam? Pariatur magnam eligendicumque error illo dignissimos tenetur beatae nobis quam? Pariatur magnam eligendicumque error illo dignissimos tenetur beatae nobis quam? Pariatur magnam eligendi.cumque error illo dignissimos tenetur beatae nobis quam? Pariatur magnam eligendi....</p>
                    </div>
                   <section className=" bg-opacity-30 px-2 py-3 flex justify-center items-center bg-slate-500  mx-3 mt-2  gap-11 rounded-xl shadow-2xl max-sm:gap-0 max-sm:mt-10 max-md:gap-40 max-md:mt-40 max-md:p-5 md:gap-20">
