        ...
        <div className="bg-blue-950 h-screen "> 
            ...
            <main  className=' bg-blue-950 flex justify-center items-top  max-w-full'>
                ...
                <section>
                   ...
                   <section className=" bg-opacity-30 px-2 py-3 flex justify-center items-center bg-slate-500  mx-10   gap-11 rounded-xl shadow-2xl max-sm:gap-0 max-sm:mt-10 max-md:gap-40 max-md:mt-40 max-md:p-5 md:gap-20 mb-24 mt-20 md:mt-40 xl:gap-20 xl:w-1/2 xl:mx-auto lg:mt-30 xl:mt-52 ">
